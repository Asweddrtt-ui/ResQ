                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 5.h),
                      Text(
                        "Verified clinics helps us keep animals safe and healthy.",
                        style: GoogleFonts.nunito(
                          fontSize: 12.sp,
                          color: Colors.grey,
                        ),
                      ...
                      _buildTextField(hint: "123456789", controller: _phoneController, isNumber: true),
                      SizedBox(height: 15.h),
                      ...
                      GestureDetector(
                        ...
                        child: Text(
                          _selectedFileName ?? "Tap to upload document",                          style: GoogleFonts.nunito(
                          fontSize: 14.sp,
                      ...
                      Container(
                        ...
                        child: Text(
                          "Your Clinic will appear as verified after approval",
                          style: GoogleFonts.nunito(
                            color: Colors.black87,
                            fontSize: 12.sp,
